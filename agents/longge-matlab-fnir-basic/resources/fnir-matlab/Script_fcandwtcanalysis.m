...
% --- 参数设置部分 ---
dataFolder = 'D:\Research data\Study_AI_hyperscanning\Raw data\NIRS_SPARK\New Folder';
filePrefix = 'wtccbsi';
freqRange = 1:109;
sampling_rate = 11;
event_durations = [120, 300, 120, 120, 300, 120, 120, 300, 120] * sampling_rate;
...
%% ---------- 用户配置部分 ----------
filePath = 'D:\Research data\Study_AI_hyperscanning\Raw data\S4 WTC_未分阶段\';
