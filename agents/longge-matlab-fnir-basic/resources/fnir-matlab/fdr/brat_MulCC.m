function [corrected_p_val, sts] = brat_MulCC(p_vector,alpha,Type)
% correction of Multiple comparison test

% FORMAT [corrected_p_val] = brat_MulCC(P_Values,Type,alpha)
%   performs a
...
switch Type
    case 'FDR' %% false discovery rate
        denominator = sum(1./ones(1, Num_comparison));
